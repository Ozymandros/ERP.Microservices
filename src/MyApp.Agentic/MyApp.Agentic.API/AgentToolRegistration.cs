...
public static class AgentToolRegistration
{
    public static void RegisterErpTools(IServiceProvider services, IAgentToolRegistry registry)
    {
        ...
        Register(registry, "get_product_by_name", "Get a product by name from the ERP inventory service. Use for stock/product questions.", ToolHttpVerb.Get, inventory.GetProductByNameAsync);
        Register(registry, "get_warehouse_by_name", "Get a warehouse by name from the ERP inventory service.", ToolHttpVerb.Get, inventory.GetWarehouseByNameAsync);
        ...
        Register(registry, "get_customer_by_name", "Get a customer by name from the ERP sales service.", ToolHttpVerb.Get, sales.GetCustomerByNameAsync);
        ...
        Register(registry, "get_supplier_by_name", "Get a supplier by name from the ERP purchasing service.", ToolHttpVerb.Get, purchasing.GetSupplierByNameAsync);
